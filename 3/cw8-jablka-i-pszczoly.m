% lista 3, cwiczenie 8
% Czy jeden z rodzajow jabloni jest preferowany przez pszczoly je zapylajace?
...
renet = [16.5, 1, 22.6, 25.3, 23.7, 1, 23.3, 23.9, 16.2, 23.0, 21.6, 10.8, 12.2, 23.6, 10.1,24.4, 16.4, 11.7, 17.7, 34.3, 24.3, 18.7, 27.5, 25.8, 22.5, 14.2, 21.7, 1, 31.2, 13.8, 29.7,23.1, 26.1, 25.1, 23.4, 21.7, 24.4, 13.2, 22.1, 26.7, 22.7, 1, 18.2, 28.7, 29.1, 27.4, 22.3,13.2, 22.5, 25.0, 1, 6.6, 23.7, 23.5, 17.3, 24.6, 27.8, 29.7, 25.3, 19.9, 18.2, 26.2, 20.4,23.3, 26.7, 26.0, 1, 25.1, 33.1, 35.0, 25.3, 23.6,23.2, 20.2, 24.7, 22.6, 39.1, 26.5, 22.7];

disp('T-test: delikates');
[h, p] = ttest(delik, mean(delik))

disp('T-test dla renety');
[h, p] = ttest(renet, mean(renet))

disp('T-Test dla obu serii');
[h, p] = ttest2(renet, delik)

disp('KS-Test dla obu serii');
[h, p, ks] = kstest2(renet, delik)
